...
{
    public class TimeAiController : BaseController
    {
        #region 属性
        ...
        public ActionResult GetGridJson(Pagination pagination, string keyValue)
        {
            var data = new
            {
                rows = _robotApp.GetTimeAiList(pagination, keyValue),
        ...
        {
            var data = _robotApp.GetTimeAiForm(keyValue);
            return Content(data.ToJson());
        }
        ...
        public ActionResult SubmitForm(RobotGameRoomConfig robotGame, string keyValue)
        {
            _robotApp.SubmitTimeAiForm(robotGame, keyValue.ToInt());
            return Success("操作成功。");
        }
        [HttpPost]
        [HandlerAjaxOnly]
        ...
        {
            _robotApp.DeleteTimeAiForm(keyValue.ToInt());
            return Success("删除成功。");
        }
        [HttpPost]
        [HandlerAjaxOnly]
